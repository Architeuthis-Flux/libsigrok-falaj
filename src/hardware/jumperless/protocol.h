 ...
 */
 ...
 /* These must be 32 or less since many channel enable/disable masks and other
...
SR_PRIV int update_control_channel_name(struct sr_dev_inst *sdi, int channel_index, const char *new_name);
 ...
 struct dev_context {
     ...
     /* Initial Number of analog, digital, and control channels.
      ...
      * that way */
     uint8_t *d_data_buf;
     /* Control channel data buffers - can be analog or digital */
     float *c_data_bufs[MAX_CONTROL_CHANNELS];
