...
#ifndef LIBSIGROK_HARDWARE_JUMPERLESS_FALA_PROTOCOL_H
#define LIBSIGROK_HARDWARE_JUMPERLESS_FALA_PROTOCOL_H
...
struct dev_context
{
    ...
    /* Jumperless specific */
    gboolean mixed_signal_mode;    /* Support for mixed signal (logic + analog) */
    int32_t num_analog_channels;   /* Number of analog channels available */
};
...
typedef struct fala_header
{
    ...
    uint32_t before_trigger_sample_count;
    /* Jumperless extensions */
    uint32_t analog_channels;      /* Number of analog channels */
